...
if (!canMakeAiRequest($user)) {
    ...
    echo json_encode(['error' => 'Daily request limit reached. Upgrade your plan for more.']);
    exit;
}
...
if ($apiKey === '' || str_starts_with($apiKey, 'sk-your-')) {
    ...
    $responseText = "[Demo mode] OpenAI API key not configured.\n\n"
        . "Your prompt was:\n" . $prompt . "\n\n"
        . "Add a real OPENAI_API_KEY in your .env file to get live responses.";
} else {
